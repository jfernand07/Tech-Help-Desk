...
class InitialMigration1700000000000 {
    async up(queryRunner) {
        ...
        await queryRunner.createForeignKey('pedidos', new typeorm_1.TableForeignKey({
        ...
        await queryRunner.createForeignKey('pedido_items', new typeorm_1.TableForeignKey({
        ...
        await queryRunner.createIndex('productos', new typeorm_1.TableIndex({ columnNames: ['categoria'] }));
        await queryRunner.createIndex('pedidos', new typeorm_1.TableIndex({ columnNames: ['estado'] }));
        await queryRunner.createIndex('pedidos', new typeorm_1.TableIndex({ columnNames: ['cliente_id'] }));
        await queryRunner.createIndex('api_keys', new typeorm_1.TableIndex({ columnNames: ['key'] }));
    }
